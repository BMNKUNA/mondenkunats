      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-8 flex items-center justify-center gap-3 rounded-xl bg-primary/10 p-4">
          ...
          <p className="font-medium text-foreground">
            Proud 2025 Graduate in System Support from Velisa Academy
          </p>
        </div>
        ...
        <div className="mb-10 space-y-4 text-base leading-relaxed text-muted-foreground md:text-lg">
          ...
          <p>
            As a <span className="font-semibold text-foreground">fresh graduate with an NQF5 in System Support</span> from Velisa Academy (2025) and an NQF5 in Data Engineering from Explore Data Science Academy (2023), I bring a unique combination of technical expertise and eagerness to learn. My academic journey has equipped me with the skills to handle complex technical challenges, and my entrepreneurial spirit drives me to continuously push boundaries.
          </p>
          <p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl bg-card p-5 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              <span className="font-medium text-foreground">2025 Graduate</span> - NQF5 System Support (Velisa Academy) and NQF5 Data Engineering (Explore Data Science Academy, 2023).
            </p>
          </div>
          ...
          <div className="rounded-xl bg-card p-5 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              I founded <span className="font-semibold text-accent">YES TECH FIN</span> while I was doing my NQF5 System Support at Velisa Academy. Ambitious entrepreneur with a passion for learning and innovation.
            </p>
          </div>
        </div>

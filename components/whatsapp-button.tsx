          ...
          <div className="relative w-full max-w-sm rounded-2xl bg-card p-6 shadow-2xl">
            ...
            <div className="text-center">
              ...
              <p className="mb-6 text-sm text-muted-foreground">
                Hi there! Feel free to reach out on WhatsApp. {"I'd"} love to chat about opportunities, collaborations, or just have a friendly conversation.
              </p>
              ...
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-3 font-medium text-white transition-colors hover:bg-[#128C7E]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
